...
> /opt/arduino-1.8.3/arduino --pref "boardsmanager.additional.urls=http://arduino.esp8266.com/stable/package_esp8266com_index.json" --save-prefs
> /opt/arduino-1.8.3/arduino --install-boards esp8266:esp8266 --save-prefs
...
> wget ftp://cddis.nasa.gov/gnss/data/daily/<4-digit year>/brdc/brdc<3-digit date>0.<2-digit year>n.Z
> uncompress brdc<3-digit date>0.<2-digit year>n.Z

Formatted example (year - 2019, date - 25 October):
> wget ftp://cddis.nasa.gov/gnss/data/daily/2019/brdc/brdc2980.19n.Z
...
Next, a command line text stream editor called SED is used to insert/replace a line in the C code with our text. Specifically for our code, the global variable will sit at the 2nd line of code to avoid tempering with the main code beneath it.
Commands used:
